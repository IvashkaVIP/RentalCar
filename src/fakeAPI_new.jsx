[
  {
    ...
    "model": "Enclave",
    "type": "SUV",
    "img": "https://media.ed.edmunds-media.com/buick/enclave/2008/lt/2008_buick_enclave_f34_lt_1_717.jpg",
  ...
  },
  {
    ...
    "model": "RX",
    "type": "SUV",
    "img": "https://cdn.jdpower.com/JDPA_2022%20Lexus%20NX%20Gray%20Front%20Quarter%20Action.jpg",
    "description": "The Lexus RX is a luxury SUV that combines a striking design with a comfortable and well-appointed interior.",
    "fuelConsumption": "8.5",
    "engineSize": "3.5L V6",
    "accessories": [
      "Semi-Aniline perforated leather seats",
    ...
    "rentalPrice": "$48",
    "rentalCompany": "Luxury Car Rentals",
    "address": "123 Sample Street, Kyiv, Ukraine",
    "rentalConditions": "Minimum age: 25\nValid driver's license\nSecurity deposit required",
    "mileage": 6000
  },
  {
    ...
    "model": "X5",
    "type": "SUV",
    "img": "https://cdn0.riastatic.com/photosnew/auto/photo/bmw_x5__469997590f.jpg",
    "description": "The BMW X5 is a luxury SUV that offers a perfect blend of performance, comfort, and cutting-edge technology.",
    "fuelConsumption": "9.0",
    ...
    "address": "654 Example Road, Kyiv, Ukraine",
  ...
  },
  {
    ...
    "model": "Levante",
    "type": "SUV",
    "img": "https://images.drive.com.au/caradvice/image/private/c_fill,f_auto,g_auto,h_1080,q_auto:eco,w_1920/v1/u36aychwfoboufhloleu",
    "description": "The Maserati Levante is a luxury SUV that combines Italian elegance with thrilling performance and a sumptuous interior.",
    "fuelConsumption": "11.1",
    "engineSize": "3.0L V6",
    "accessories": [
      "Silk and leather upholstery",
      "Maserati Touch Control Plus infotainment",
    ...
    "rentalPrice": "$60",
    "rentalCompany": "Luxury Car Rentals",
    "address": "321 Sample Boulevard, Lviv, Ukraine",
    "rentalConditions": "Minimum age: 25\nValid driver's license\nSecurity deposit required",
    "mileage": 7200
  },
  {
    ...
    "model": "Q7",
    "type": "SUV",
    "img": "https://media.ed.edmunds-media.com/audi/q7/2020/oem/2020_audi_q7_4dr-suv_prestige-55-tfsi-quattro_fq_oem_1_1600.jpg",
"description": "The Audi Q7 is a luxury SUV that combines a spacious and luxurious interior with advanced technology and strong performance.",
    "fuelConsumption": "8.8",
    "engineSize": "3.0L V6",
    "accessories": [
    ...
    "address": "987 Sample Street, Odessa, Ukraine",
    "rentalConditions": "Minimum age: 25\nValid driver's license\nSecurity deposit required",
    "mileage": 5500
  },
  {
    ...
    "model": "XC90",
    "type": "SUV",
    "img": "https://media.ed.edmunds-media.com/volvo/xc90/2018/oem/2018_volvo_xc90_4dr-suv_t6-inscription_fq_oem_1_1600.jpg",
  ...
  },
  {
    ...
    "model": "XC60",
    "type": "SUV",
    "img": "https://media.ed.edmunds-media.com/volvo/xc60-polestar/2020/fd/2020_volvo_xc60-polestar_actf34_fd_823191_1600.jpg",
  ...
  },
  {
    ...
    "model": "H2",
    "type": "SUV",
    "img": "https://www.cars.com/i/large/in/v2/stock_photos/36319c41-bb6d-44fb-b684-8fd40dafa2ec/24319e61-b820-442b-affe-ec45c926ba1b.png",
  ...
  },
  {
    ...
    "model": "Outback",
    "type": "SUV",
    "img": "https://carsguide-res.cloudinary.com/image/upload/f_auto%2Cfl_lossy%2Cq_auto%2Ct_default/v1/editorial/subaru-outback-25i-premium-2016-silver-%281%29.jpg",
"description": "The Subaru Outback is a versatile and reliable SUV that combines off-road capability with a comfortable and spacious interior.",
  ...
  },
  {
    ...
    "model": "Outlander",
    "type": "SUV",
    "img": "https://www.motortrend.com/uploads/sites/10/2015/11/2010-mitsubishi-outlander-gts-awc-suv-angular-front.png",
  ...
  },
  {
    ...
    "model": "Pathfinder",
    "type": "SUV",
    "img": "https://media.ed.edmunds-media.com/nissan/pathfinder/2014/oem/2014_nissan_pathfinder_4dr-suv_platinum_fq_oem_1_1600.jpg",
  ...
  },
  {
    ...
    "model": "Navigator L",
    "type": "SUV",
    "img": "https://www.edmunds.com/assets/m/for-sale/22-5lmfl27568lj05207/img-1-600x400.jpg",
  ...
  },
  {
    ...
    "model": "Yukon Denali",
    "type": "SUV",
    "img": "https://consumerguide.com/wp-content/uploads/2014/07/00126991990008.jpg",
...
"fuelConsumption": "14.5",
  ...
  },
  {
    ...
    "model": "Tucson",
    "type": "SUV",
    "img": "https://platform.cstatic-images.com/xlarge/in/v2/stock_photos/02ba5f77-6d69-448a-8336-fae54e5bc9be/0777e5bf-c0d6-4e31-a5ac-d88c0a36787f.png",
  ...
  },
  {
    ...
    "model": "Convertible",
    "type": "Convertible",
    "img": "https://assets.carandclassic.com/listing-assets/bmw/mini-cooper-s-jcw-convertible/mini-cooper-s-jcw-convertible-r52-4B991n-v2/AkS0D66VdeW4cXN3Fd1p54GU2zO6Yu1hDufjxTku.jpg?ar=16%3A9&auto=compress&fit=crop&h=450&ixlib=php-4.1.0&q=75&w=800&s=96d17da53d5b93b4deb55d0e0add5d82",
  ...
  },
  {
    ...
    "model": "Azure",
    "type": "Convertible",
    "img": "https://media.ed.edmunds-media.com/bentley/azure/2007/oem/2007_bentley_azure_convertible_base_fq_oem_3_1600.jpg",
  ...
  },
  {
    ...
    "model": "SL-Class",
    "type": "Convertible",
    "img": "https://imagescdn.dealercarsearch.com/Media/13649/17229821/637788169192319321.jpg",
"description": "The Mercedes-Benz SL-Class is a legendary luxury convertible that offers a perfect blend of thrilling performance, advanced technology, and opulent comfort.",
  ...
  },
  {
    ...
    "model": "DBS",
    "type": "Convertible",
    "img": "https://cdn.classic-trader.com/I/images/1920_1920_inset/vehicle_ad_standard_image_2e06b139b13bef7eb948fd227ac307f5.jpg",
  ...
  },
  {
    ...
    "model": "Firebird",
    "type": "Convertible",
    "img": "https://www.motortrend.com/uploads/sites/21/2013/07/1996-ws6-ram-air-trans-am.jpg",
  ...
  },
  {
    ...
    "model": "Murcielago",
    "type": "Convertible",
    "img": "https://www.ilusso.com/imagetag/2304/main/l/Used-2009-Lamborghini-Murcielago-LP-640-1695323989.jpg",
...
"make": "Audi",
    "model": "A5",
    "type": "Convertible",
    "img": "https://mediacloud.carbuyer.co.uk/image/private/s--WP5LiK7N--/f_auto,t_content-image-full-mobile@1/v1579625975/carbuyer/used-audi-a5-1.jpg",
  ...
  },
  {
    ...
    "model": "Z8",
    "type": "Convertible",
    "img": "https://images1.bonhams.com/image?src=Images/live/2022-12/12/25275867-1-82.jpg",
  ...
  },
  {
    ...
    "model": "Camaro",
    "type": "Convertible",
    "img": "https://www.motorbiscuit.com/wp-content/uploads/2020/06/Chevrolet-Camaro-2002-front.jpg",
  ...
  },
  {
    ...
    "model": "SLK-Class",
    "type": "Convertible",
    "img": "https://cdn.dealeraccelerate.com/pjs/1/638/18890/1920x1440/2006-mercedes-benz-slk-280-convertible",
...
"mileage": 6280
  },
  {
    ...
    "model": "Voyager",
    "type": "Van/Minivan",
    "photoLink": "https://media.ed.edmunds-media.com/chrysler/voyager/2020/oem/2020_chrysler_voyager_passenger-minivan_lx_fq_oem_1_1600.jpg",
  ...
  },
  {
    ...
    "model": "Rio",
    "type": "Hatchback",
    "photoLink": "https://mediacloud.carbuyer.co.uk/image/private/s--jkd-ohdo--/v1595108797/carbuyer/2020/05/press_cmyk_300_134-front.jpg",
  ...
  },
  {
    ...
    "model": "XC60",
    "type": "SUV",
    "photoLink": "https://media.ed.edmunds-media.com/volvo/xc60-polestar/2020/fd/2020_volvo_xc60-polestar_actf34_fd_823191_1600.jpg",
  ...
  },
  {
    ...
    "type": "SUV",
    "photoLink": "https://images.drive.com.au/caradvice/image/private/c_fill,f_auto,g_auto,h_1080,q_auto:eco,w_1920/v1/nbvpnplemmfj3ohpjcyi",
...
"Adaptive Dynamics suspension"
  ...
  },
  {
    ...
    "model": "GLE",
    "type": "SUV",
    "img": "https://www.buyacar.co.uk/media/drupal/mercedes_gle_header.jpg?width=759&height=427&format=webp",
    "description": "The Mercedes-Benz GLE is a premium SUV that combines opulent luxury with advanced safety features and robust performance.",
    "fuelConsumption": "9.5",
    "engineSize": "3.5L V6",
    "accessories": [
      "Nappa leather seats",
    ...
    "rentalPrice": "$55",
    "rentalCompany": "Adventure Car Rentals",
    "address": "987 Sample Street, Kyiv, Ukraine",
    "rentalConditions": "Minimum age: 25\nValid driver's license\nSecurity deposit required",
    "mileage": 8500
  },
  {
    ...
    "description": "The Audi Q7 is a sophisticated and powerful SUV known for its cutting-edge technology and elegant design.",
    "fuelConsumption": "9.8",
    "engineSize": "3.0L V6",
    "accessories": [
      "Leather seats",
    ...
    "rentalPrice": "$45",
    "rentalCompany": "Premium Auto Rentals",
    "address": "456 Sample Avenue, Lviv, Ukraine",
    "rentalConditions": "Minimum age: 25\nValid driver's license\nSecurity deposit required",
    "mileage": 7200
  },
  {
    ...
    "model": "RX",
    "type": "SUV",
    "img": "https://images.hgmsites.net/hug/2018-lexus-rx_100612142_h.jpg",
    "description": "The Lexus RX is a stylish and reliable luxury SUV with a focus on comfort, advanced technology, and fuel efficiency.",
    "fuelConsumption": "8.7",
    "engineSize": "3.5L V6",
    "accessories": [
    ...
    "rentalPrice": "$48",
    "rentalCompany": "Premium Auto Rentals",
    "address": "654 Example Road, Kharkiv, Ukraine",
    "rentalConditions": "Minimum age: 23\nValid driver's license\nCredit card required",
    "mileage": 7800
  },
  {
    ...
    "model": "Model X",
    "type": "SUV",
    "img": "https://carsguide-res.cloudinary.com/image/upload/f_auto,fl_lossy,q_auto,t_cg_hero_large/v1/editorial/Tesla-Model-X-silver-2017-suv-image-credit-richard-berry-%283%29.jpg",
    "description": "The Tesla Model X is an all-electric SUV with futuristic features, impressive acceleration, and a sleek, minimalist design.",
    ...
    "rentalPrice": "$65",
    "rentalCompany": "Luxury Car Rentals",
    "address": "654 Example Boulevard, Lviv, Ukraine",
    "rentalConditions": "Minimum age: 25\nValid driver's license\nSecurity deposit required",
    "mileage": 6000
  }
]